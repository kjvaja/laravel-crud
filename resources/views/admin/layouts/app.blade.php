<html>
    <head>
        ...
        <link rel="stylesheet" href="{{asset('storage/admin-assets/plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
        <!-- iCheck -->
        <link rel="stylesheet" href="{{asset('storage/admin-assets/plugins/icheck-bootstrap/icheck-bootstrap.min.css')}}">
        <!-- JQVMap -->
        <link rel="stylesheet" href="{{asset('storage/admin-assets/plugins/jqvmap/jqvmap.min.css')}}">
        <!-- Theme style -->
